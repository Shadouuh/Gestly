  ...
  return (
    <div className="relative min-h-full overflow-hidden bg-[color:var(--app-bg)] text-[color:var(--text)]">
      ...
      <div className="relative mx-auto flex w-full max-w-5xl items-center justify-center px-4 py-8 sm:px-6 sm:py-10 lg:py-14">
        <div className="w-full overflow-hidden rounded-[2.75rem] border border-black/10 bg-white/70 shadow-[0_28px_80px_rgba(0,0,0,0.12)] backdrop-blur">
          <div className="grid lg:grid-cols-2">
            <div className="relative overflow-hidden border-b border-black/10 bg-gradient-to-br from-white to-[#f4f7ff] p-7 sm:p-10 lg:border-b-0 lg:border-r">
              <div className="pointer-events-none absolute inset-0">
              ...
              <div className="relative">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-lg font-semibold tracking-tight text-black">Gestly</div>
                </div>

                <h2 className="mt-7 text-balance text-3xl font-semibold leading-tight tracking-tight text-black sm:text-4xl">
                  Entrá y empezá a vender en segundos.
                </h2>
                <p className="mt-3 max-w-md text-sm leading-relaxed text-black/65 sm:text-base">
                ...
                <div className="mt-8 grid gap-3">
                  {[
                    ...
                    <div
                      key={title}
                      className="flex items-center justify-between gap-4 rounded-3xl border border-black/10 bg-white/70 px-4 py-3 shadow-[0_1px_0_rgba(0,0,0,0.04)] backdrop-blur"
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs tracking-tight text-black/60">{subtitle}</div>
                        </div>
                      </div>
                ...
                <div className="mt-8 rounded-3xl border border-black/10 bg-white/70 p-4 text-sm tracking-tight text-black/70 backdrop-blur">
                  <span className="font-semibold text-black">Demo:</span> {`demo@gestly.app`} / demo
                </div>
              </div>
            </div>

            <div className="p-7 sm:p-10">
              <div className="mb-8 flex gap-2 rounded-3xl border border-black/10 bg-white/70 p-1.5 backdrop-blur">
            <button
              type="button"
              onClick={() => setActiveTab('login')}
              className={[
                'flex-1 rounded-2xl px-4 py-3 text-sm font-semibold tracking-tight transition-colors',
                activeTab === 'login'
                  ? 'bg-white text-black shadow-[0_10px_24px_rgba(0,0,0,0.10)]'
          ...
          {activeTab === 'login' && (
            <div>
              ...
              <form onSubmit={onLoginSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-3 top-1/2 -translate-y-1/2 rounded-xl p-1.5 text-black/45 hover:bg-black/5 hover:text-black"
                    >
                ...
                {authError && (
                  <div className="rounded-2xl border border-black/10 bg-white/70 p-3 text-sm tracking-tight text-black">
                    {authError}
                  </div>
                )}
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="h-12 w-full rounded-2xl border-transparent bg-[#0a84ff] text-white hover:bg-[#0a84ff]/90"
                >
                  {isLoading ? (
                    'Iniciando sesión…'
                  ) : (
                  ...
                  <div className="flex items-center gap-1">
                    <div
                      className={[
                        ...
                        regStep >= 1 ? 'bg-[#0a84ff]' : 'bg-black/10',
                      ].join(' ')}
                    />
                    <div
                      className={[
                        'h-2 w-2 rounded-full',
                        regStep >= 2 ? 'bg-[#0a84ff]' : 'bg-black/10',
                      ].join(' ')}
                    />
                  </div>
